...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2023 at 07:22 PM
...
--
ALTER TABLE `exam`
  MODIFY `exammulti_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `identification`
  MODIFY `examiden_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
COMMIT;
